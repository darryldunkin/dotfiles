...
hi comment              guifg=#428BDD       ctermfg=lightBlue cterm=none
hi constant             guifg=#00CC00       ctermfg=lightGreen
hi identifier   guifg=white         ctermfg=white
hi statement    guifg=#F9BB00       gui=none    ctermfg=yellow cterm=none
hi preproc              guifg=#F9BB00       ctermfg=yellow  cterm=none
